...
def plot_results(rewards_per_episode,different_nsteps):
...
rewards_per_episode = np.zeros((len(different_nsteps), num_episodes))
env = gym.make(name_env)
...
for ns in range(0,len(different_nsteps)):
        ...
        for i in range(0,n_sim):
                ...
                rewards_per_episode[ns] += agent.sum_eps_rwd[0:num_episodes]
env.close()
rewards_per_episode /= n_sim
plot_results(rewards_per_episode,different_nsteps)
